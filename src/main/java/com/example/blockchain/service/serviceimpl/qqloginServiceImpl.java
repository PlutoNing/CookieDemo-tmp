...
import com.example.blockchain.service.qqloginService;
...
public class qqloginServiceImpl implements qqloginService {
    ...
    public int haslogined(String openid) throws SQLException {
        ...
        String sql = "Select * from user_oauth_qq where idp_username = '" + openid + "' ";
    ...
    public User newuser(String openid) throws SQLException {
        ...
        DbUtil dbUtil = new DbUtil();
        String sql = "insert into user_oauth_qq (`userid`,`username`,`idp_username`) values ('"+userid+"','"+ username + "','"+ openid +"');";
    ...
    public User olduser(String openid) throws SQLException {
        DbUtil dbUtil = new DbUtil();
        String sql = "Select username from user_oauth_qq where idp_username = '" + openid + "' ";
        ResultSet resultSet = dbUtil.resultSet(sql);
        String username= "";
        if (resultSet.next()){
